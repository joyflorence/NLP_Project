...
const AUTH_TOKEN_KEY = (import.meta as any).env.VITE_AUTH_TOKEN_KEY ?? "access_token";
const STATIC_API_KEY = (import.meta as any).env.VITE_API_KEY;
const USE_MOCK_API = ((import.meta as any).env.VITE_USE_MOCK_API ?? "false") === "true"; // Disabled for admin
...
export const api = USE_MOCK_API ? { ...httpApi } : httpApi; // Mock disabled for admin