...
export function App() {
  ...
  async function refreshSavedDocuments(nextIsAuthenticated: boolean) {
  ...
  useEffect(() => {
    ...
    supabase.auth.getSession().then(async ({ data }) => {
      ...
      await refreshSavedDocuments(nextIsAuthenticated);
    });
  ...
  async function handleToggleSavedDocument(doc: DocumentRecord) {
    ...
    try {
      ...
      await refreshSavedDocuments(true);
    } catch (err) {
  ...
  return (
    <main className="layout">
      ...
      <Routes>
        ...
        <Route
          path="/library"
          element={<LibraryPage savedDocuments={savedDocuments} isAuthenticated={isAuthenticated} onDownloadDocument={downloadDocument} onToggleSaveDocument={handleToggleSavedDocument} onSaveNote={handleSaveNote} isDocumentSaved={handleIsSaved} />}
        />
